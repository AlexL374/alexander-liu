...
function Skills() {
    ...
    const skillsIcons = [cpp, python, git, java, react, latex]
    const dimensions = [{ height: '8vh', width: '8vh' }, { height: '8vh', width: '7vh' }, { height: '8vh', width: '8vh' }, { height: '8vh', width: '8vh' }, { height: '7vh', width: '8vh' }, { height: '5vh', width: '11vh' }];
                ...
                <Parallax speed={30} class='middle'>
                    <div class='skills'>
                        ...
                        <div class='skills-outer'>
                            {skills.map((e, index) => {
                                return (
                                    <Card sx={{ minWidth: 275, maxWidth: '15vw', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center', marginBottom: '3vh' }}>
                                        <CardMedia
                                            sx={dimensions[index]}
